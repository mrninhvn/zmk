...
$options = "BlueMicro840 v1", "nice!nano v2", "nice!nano v1", "nRF52840 M.2 Module", "nRFMicro 1.1 (flipped)", "nRFMicro 1.1/1.2", "nRFMicro 1.3/1.4", "QMK Proton-C", "Mikoto 5.20",  "" | Where-Object { $_ -ne "" }
$boards = "bluemicro840_v1", "nice_nano_v2", "nice_nano", "nrf52840_m2", "nrfmicro_11_flipped", "nrfmicro_11", "nrfmicro_13", "proton_c", "mikoto_520",  "" | Where-Object { $_ -ne "" }
...
$options = "A. Dux", "BFO-9000", "Boardsource 3x4 Macropad", "Corne", "Cradio&#x2F;Sweep", "CRBN Featherlight", "eek!", "Helix", "Iris", "Jian", "Jorne", "Kyria", "Lily58", "MakerDiary m60", "Microdox", "Naked60", "Nibble", "QAZ", "Quefrency Rev. 1", "REVIUNG41", "Romac+ Macropad", "Romac Macropad", "Sofle", "Splitreus62", "TG4x", "Tidbit Numpad", "Zodiark",  "" | Where-Object { $_ -ne "" }
$names = "a_dux", "bfo9000", "boardsource3x4", "corne", "cradio", "crbn", "eek", "helix", "iris", "jian", "jorne", "kyria", "lily58", "m60", "microdox", "naked60", "nibble", "qaz", "quefrency", "reviung41", "romac_plus", "romac", "sofle", "splitreus62", "tg4x", "tidbit", "zodiark",  "" | Where-Object { $_ -ne "" }
$splits = "y", "y", "n", "y", "y", "n", "n", "y", "y", "y", "y", "y", "y", "n", "y", "n", "n", "n", "y", "n", "n", "n", "y", "y", "n", "n", "y",  "" | Where-Object { $_ -ne "" }
